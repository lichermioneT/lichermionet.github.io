...
面向对象会识别问题中的对象，并把数据和操作数据的方法放在一起。**面向对象主要是：函数和方法绑定在一起**
...
函数需要显式接收结构体指针，才能知道要操作哪个学生。类似C++的 this 指针。
...
{
public:
    void f1() {}  // void f1(A* this){}
    void f2() {}  // void f2(A* this){}
    void f3() {}  // void f3(A* this){}
...
first.setDate(2026, 8, 15); // first.setDate(&first, 2026, 8, 15); 
second.setDate(2027, 1, 1); // second.setDate(&second, 2027, 1, 1);
```
